...
class XposedInit : XposedModule() {
    ...
    private fun enableTripleRowStatusBar() {
        val cls = safeLoadClass("com.android.systemui.statusbar.phone.MiuiPhoneStatusBarView") ?: return
        try {
    ...
    private fun setupColoredNotifications() {
        val cls = safeLoadClass("com.android.systemui.statusbar.notification.row.MiuiNotificationContentView") ?: return
        try {
